...
INSERT INTO `tbcitas` VALUES (1,'Josue Flores',26,'Masculino','josuecumtual2024@gmail.com','5584893998',2,2,'2025-05-21','20:00','pendiente',500.00,'DM-00001','Prueba','2025-05-21 17:21:28','2025-05-21 17:21:28');
...
BEGIN
  ...
  SET vFolioGenerado = CONCAT(vInicialesDoctor, '-', LPAD(vConsecutivo, 5, '0'));
	...
	INSERT INTO tbCitas(strNombrePaciente,intEdad,strGenero,strCorreoPaciente,strTelefonoPaciente,idEspecialidad,intDoctor,datFecha,intHora,strEstatusPago,dblTotal,strFolio,strMotivo,datFechaAlta,datFechaModificacion)
    VALUES(sp_strNombrePaciente,sp_intEdad ,sp_strGenero ,sp_strCorreoPaciente,sp_strTelefonoPaciente,sp_idEspecialidad,sp_intDoctor,sp_datFecha,sp_intHora,'PENDIENTE','500.00',vFolioGenerado,sp_strMotivo,now(),now());
...
-- Dump completed on 2025-05-21 18:04:05
