...
CREATE TABLE `tbcitas` (
  ...
  `strPaciente` varchar(100) NOT NULL,
  `datFecha` date NOT NULL,
  `intHora` int(11) NOT NULL,
  `intDoctor` int(11) NOT NULL,
  `intEspecialidad` int(11) NOT NULL,
  `strEstatus` varchar(100) NOT NULL,
...
INSERT INTO `tbroles` VALUES (1,'Super Administrador',1),(2,'Administrador',1),(3,'Paciente',1),(4,'Doctor',1);
...
INSERT INTO `tbusuarios` VALUES (1,'Josue Flores','5584893998','mkt.esymbel2025@gmail.com',1,'LOGIN','2025-05-06 00:00:00','admin','admin'),(2,'Josue Flores',NULL,'josuecumtual2024@gmail.com',3,'LOGIN','2025-05-06 16:34:46',NULL,NULL);
...
-- Dump completed on 2025-05-06 17:51:33
